...
9. **[サブネット名]** で、**[default]** という単語をクリックします。存在しない場合は**サブネットの追加**をクリックします。
...
3. **[Firewall Manager]** ページで、[概要] タブから **[View secured virtual hubs](セキュリティ保護付き仮想ハブの表示)** をクリックします。
...
7. **[Policy tier](ポリシー レベル)** で **[Standard]** を選びます。
...
32. **[ターゲット]** に、前に記録しておいたファイアウォール仮想ハブのパブリック IP アドレス (例: **51.143.226.18**) を入力します。

31. **[変換されたタイプ]** で **[IP アドレス]** を選択します。
...
47. **[ターゲット]** に、前に記録しておいた **Srv-workload-02** のプライベート IP アドレス (例: **10.1.1.4**) を入力します。
...
2. **Hub-01** をクリックします。**Hub01がグレーバックしている場合は、画面をリフレッシュしてください。**
