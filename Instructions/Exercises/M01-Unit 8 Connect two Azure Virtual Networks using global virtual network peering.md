...
Exercise:
  ...
  description: 仮想ネットワーク ピアリングを構成しテストします。
  duration: 20 minutes
  level: 300
  islab: true
  primarytopics:
...
+ [Azure Virtual Network ピアリングを構成します](https://learn.microsoft.com/training/modules/configure-vnet-peering/)。 Azure Virtual Network ピアリング接続を構成し、転送と接続の問題に対処する方法について学習します。
