...
1. **[次へ: アドレス空間]** を選択します。 既定値として既に表示されていない場合は、IPv4 アドレス空間「10.0.0.0/16」を入力します。

1. **[既定]** サブネットの横にある **[編集]** アイコンをクリックします。

1. **[サブネットの目的]** ドロップダウンで **[Azure Firewall]** を選択します。 

1. **[開始アドレス]** を「**10.0.1.0/26**」に変更します。
...
1. **[開始アドレス/サイズ]** を「**10.0.2.0/24**」に変更します。
...
+ Azure Firewall は、Standard、Premium、Basic の 3 つの SKU で提供されています。
